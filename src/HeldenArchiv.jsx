...
const NACHTEIL_TYPES = [
  ...
  { kategorie: 'Magisch', name: 'Thesisgebunden', gp: '1', leveled: true },
  { kategorie: 'Magisch', name: 'Unfähigkeit für [Merkmal]', gp: '?' },
  { kategorie: 'Magisch', name: 'Unverträglichkeit mit verarbeitetem Metall', gp: '10' },
  { kategorie: 'Magisch', name: 'Wahrer Name', gp: '5' },
  { kategorie: 'Magisch', name: 'Weltfremd', gp: '3', leveled: true },
  { kategorie: 'Magisch', name: 'Wilde Magie', gp: '7' },
  { kategorie: 'Magisch', name: 'Zielschwierigkeiten', gp: '7' },
  { kategorie: 'Magisch', name: 'Zögerlicher Zauberer', gp: '2', leveled: true },
  // Sozial
...
const SF_TYPES = [
  ...
  { kategorie: 'Magisch', name: 'Eiserner Wille I', ap: '200' },
  { kategorie: 'Magisch', name: 'Eiserner Wille II', ap: '300' },
  { kategorie: 'Magisch', name: 'Elementarharmonisierte Aura', ap: '700' },
  { kategorie: 'Magisch', name: 'Elfenlied: Sorgenlied', ap: '75' },
  { kategorie: 'Magisch', name: 'Elfenlied: Zaubermelodie', ap: '150' },
  { kategorie: 'Magisch', name: 'Elfenlied: Friedenslied', ap: '250' },
  { kategorie: 'Magisch', name: 'Elfenlied: Windgeflüster', ap: '100' },
  { kategorie: 'Magisch', name: 'Elfenlied: Lied der Lieder', ap: '150' },
  { kategorie: 'Magisch', name: 'Elfenlied: Freundschaftslied', ap: '50' },
  { kategorie: 'Magisch', name: 'Elfenlied: Erinnerungsmelodie', ap: '150' },
  { kategorie: 'Magisch', name: 'Elfenlied: Melodie der Kunstfertigkeit', ap: '250' },
  { kategorie: 'Magisch', name: 'Elfenlied: Lied des Trostes', ap: '150' },
  { kategorie: 'Magisch', name: 'Elfenlied: Lied der Reinheit', ap: '150' },
  { kategorie: 'Magisch', name: 'Fernzauberei', ap: '150' },
  { kategorie: 'Magisch', name: 'Gedankenschutz', ap: '300' },
  { kategorie: 'Magisch', name: 'Gefäss der Sterne', ap: '200' },
  { kategorie: 'Magisch', name: 'Grosse Meditation (Ritual)', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Angste mehren', ap: '75' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Beiss auf Granit', ap: '150' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Beute', ap: '75' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Hagelschlag', ap: '150' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Hexenschuss', ap: '75' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Kornfäule', ap: '125' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Krötenkuss', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Mit Blindheit schlagen', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Pech an den Hals', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Pestilenz', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Schlaf rauben', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Todesfluch', ap: '100' },
  { kategorie: 'Magisch', name: 'Hexenfluch: Unfruchtbarkeit', ap: '50' },
  ...
  { kategorie: 'Magisch', name: 'Kugelzauber: Bindung', ap: '100' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Brennglass und Prisma', ap: '50' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Schutz gegen Untote', ap: '150' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Warnendes Leuchten', ap: '100' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Kugel des Hellsehers', ap: '150' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Kugel des Illusionisten', ap: '200' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Orbitarium', ap: '100' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Bilderspiel', ap: '50' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Fernbild', ap: '150' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Bildergalerie', ap: '75' },
  { kategorie: 'Magisch', name: 'Kugelzauber: HSzints Auge', ap: '75' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Farben des Geistes', ap: '150' },
  { kategorie: 'Magisch', name: 'Kugelzauber: Wachendes Auge', ap: '200' },
  { kategorie: 'Magisch', name: 'Lockeres Zaubern', ap: '400' },
  { kategorie: 'Magisch', name: 'Matrixkontrolle', ap: '300' },
  { kategorie: 'Magisch', name: 'Matrixregeneration I', ap: '200' },
  { kategorie: 'Magisch', name: 'Matrixregeneration II', ap: '500' },
  { kategorie: 'Magisch', name: 'Matrixverständnis', ap: '400' },
  { kategorie: 'Magisch', name: 'Meisterliche Regeneration', ap: '200' },
  { kategorie: 'Magisch', name: 'Meisterliche Zauberkontrolle', ap: '300' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Dämonisch (einzeln)', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Elementar (einzeln)', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Geisterwesen', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Heilung', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Herbeirufung', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Illusion', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Schaden', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Telekinese', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Verständigung', ap: '60' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Antimagie', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Beschwörung', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Eigenschaften', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Einfluss', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Form', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Hellsicht', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Herrschaft', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Illusion', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Kraft', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Object', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Umwelt', ap: '90' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Dämonisch (gesamt)', ap: '120' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Elementar (gesamt)', ap: '120' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Limbisch', ap: '120' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Metamagie', ap: '120' },
  { kategorie: 'Magisch', name: 'Merkmalskenntnis: Temporal', ap: '120' },
  { kategorie: 'Magisch', name: 'Ottagaldr', ap: '200' },
  { kategorie: 'Magisch', name: 'Regeneration I', ap: '100' },
  { kategorie: 'Magisch', name: 'Regeneration II', ap: '100' },
  { kategorie: 'Magisch', name: 'Repräsentation', ap: '2000' },
  { kategorie: 'Magisch', name: 'Ritualkenntnis', ap: '?' },
  { kategorie: 'Magisch', name: 'Runenkunde', ap: '200' },
  { kategorie: 'Magisch', name: 'Salasandra', ap: '200' },
  { kategorie: 'Magisch', name: 'Schalenzauber: Weihe der Schale', ap: '100' },
  { kategorie: 'Magisch', name: 'Schalenzauber: Allegorische Analyse', ap: '125' },
  { kategorie: 'Magisch', name: 'Schalenzauber: Chymische Hochzeit', ap: '100' },
  { kategorie: 'Magisch', name: 'Schalenzauber: Mandricons Bindung', ap: '75' },
  { kategorie: 'Magisch', name: 'Schalenzauber: Feuer and Ice', ap: '150' },
  { kategorie: 'Magisch', name: 'Schalenzauber: Transmutation der Elemente', ap: '125' },
  // Geweiht / Klerikal
